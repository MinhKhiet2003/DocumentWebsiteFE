  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const userResponse = await fetch('http://20.28.55.54:5168/api/User/count', {
          method: 'GET',
          headers: {
        ...
        const categoryResponse = await fetch('http://20.28.55.54:5168/api/Categories/count-by-class', {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
          },
