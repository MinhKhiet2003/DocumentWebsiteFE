...
const CommonResource = ({
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [location.search, filters, apiEndpoint, title]);
    ...
    <div className="flex-wrap">
      ...
      <div className="Resource-container">
        ...
        <div className="resource-header">
          ...
          <p className="total-items">Tổng số: {items.length}</p>
          {additionalFilters && (
                  ...
                  <div className="card">
                    <div className="card-image">
                      <img
                        src={
                          item[imageField] ||
                          'https://hoctot.hocmai.vn/wp-content/uploads/2020/07/on-tap-hoa-hoc.png'
                        }
                        alt={item[titleField]}
                      />
                    </div>
                    <div className="card-content">
                      ...
                      <p className="text-muted">
                        {item[descriptionField] || 'Không có mô tả'}
                      </p>
                      {item.classify && (
                        <p>
                          <small>Phân loại: {item.classify}</small>
                        </p>
                      )}
                      <p>
                        <small>
                          Tác giả: {item[authorField] || 'Không xác định'}
                        </small>
                      </p>
                      <div className="card-footer">
                        <StarRating averageRating={item.averageRating || 0} />
                        <span className="ms-2">
                          {item.commentCount || 0} phản hồi
                        </span>
                      </div>
                    </div>
                  </div>
